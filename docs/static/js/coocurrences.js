function select_json(new_json, parent) {
    ...
    d3.json(new_json, function (json_data) {
        ...
        json_data.links.forEach(function (link) {
            var source = nodes.filter(function(obj) { return obj.id === link.source; }).shift();
            var target = nodes.filter(function(obj) { return obj.id === link.target; }).shift();
...
select_json("cooccurences.json", '#all_books');
select_json("book/1/cooccurences.json", '#book1');
select_json("book/2/cooccurences.json", '#book2');
select_json("book/3/cooccurences.json", '#book3');
